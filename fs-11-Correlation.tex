...
\begin{frame}
  ...
  eruption. It turns out there is a correlation between the two
  variables. The data is available on R Statistics in the dataframe
  called \texttt{faithful}.
\end{frame}

\begin{frame}
  \frametitle{Confidence Interval for Regression Line Slope}
\begin{figure}[h]
\includegraphics[scale=.5]{./diagrams/faithful.png}
\end{figure}
\end{frame}
