...
\begin{frame}
  \frametitle{Confidence Interval for Regression Line Slope}
\begin{figure}[h]
\includegraphics[scale=.4]{./diagrams/faithful.png}
\end{figure}
\end{frame}
...
\begin{equation}
  \label{eq:gaeyiegh}
E=t_{\frac{\alpha}{2}}\frac{s_{e}\sqrt{\sum{}x^{2}}}{\sqrt{n}\left(\sum{}x^{2}-\frac{\left(\sum{}x\right)^{2}}{n}\right)}=1.968789\cdot\frac{5.914\cdot{}60.51297}{\sqrt{272}\cdot\left(3661.819-\frac{899988.1}{272}\right)}=0.12101
\end{equation}
