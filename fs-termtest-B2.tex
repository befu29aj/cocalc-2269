...
In a meat manufacturing plant, cattle are processed at a work station. On average, 0.66 cattle per hour create problems that cause an interruption in the work flow. Calculate the probability that a work station will experience strictly less than four interruptions on a given work day (eight hours).
