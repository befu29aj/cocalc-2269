...
\newcommand{\mair}{433}
\newcommand{\utit}{90}
\newcommand{\jief}{10,000}
\newcommand{\caib}{34}
\newcommand{\eizi}{13,896}
\newcommand{\afie}{0.05}
\newcommand{\uphe}{14}
\newcommand{\kieg}{5}
\newcommand{\aequ}{99}
\newcommand{\aiza}{344}
\newcommand{\ajoo}{1,200}
\newcommand{\icoo}{361}
\newcommand{\phae}{110}
\newcommand{\usha}{1.2}
\newcommand{\oaga}{60}
...
\newcommand{\mair}{451}
\newcommand{\utit}{95}
\newcommand{\jief}{8,100}
\newcommand{\caib}{36}
\newcommand{\eizi}{11,256}
\newcommand{\afie}{0.05}
\newcommand{\uphe}{18}
\newcommand{\kieg}{4}
\newcommand{\aequ}{99}
...
\newcounter{aufgb}
\setcounter{aufgb}{0}
\newcommand{\aufgabex}[1]{\refstepcounter{aufgb}\textbf{(\arabic{aufgb})} [#1 points]}
...
\aufgabe{Brain Volumes of Twins} Listed below are brain volumes
...
\begin{frame}
  \frametitle{Exercises}
\aufgabe{Proctored and Nonproctored Tests} In a study of proctored
...
\begin{frame}
  \frametitle{Exercises}
\aufgabe{Dreaming in Black and White} A study was conducted to determine
...
\begin{frame}
  \frametitle{Exercises}
\aufgabe{Cardiac Arrest at Day and Night} A study investigated
...
\begin{frame}
  \frametitle{Exercises}
\aufgabe{IQ and Lead Exposure} A data set lists full IQ scores for
...
\begin{frame}
  \frametitle{Exercises}
\aufgabe{Ginkgo for Dementia} The herb ginkgo biloba is commonly used
...
\begin{frame}
  \frametitle{Exercises}
\aufgabe{Are Seat Belts Effective?} A simple random sample of front-seat
...
\begin{frame}
  \frametitle{Exercises}
\aufgabe{Body Mass Index} We know that the mean weight of men is
...
\begin{frame}
  \frametitle{Exercises}
\aufgabe{Do Men Talk Less Than Women?} The accompanying table
...
\begin{frame}
  \frametitle{Exercises}
\aufgabe{Body Temperatures} Listed below are body temperatures of four
...
\aufgabex{5} A sample of {\ufoj} historians responded to questions
...
\begin{frame}
  \frametitle{Term Test C}
\aufgabex{5} An accountant wants to test the null hypothesis that the
...
\begin{frame}
  \frametitle{Term Test C}
\aufgabex{5} A company believes its market share is about {\uphe}\%.
...
\begin{frame}
  \frametitle{Term Test C}
\aufgabex{5} The average weekly earnings for all full-time-equivalent
...
\begin{frame}
  \frametitle{Term Test C}
\aufgabex{5} A wine importer needs to report the average percentage of
